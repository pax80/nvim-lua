...
--
--     if name == "type" then
--       if type == "atx_h1_marker" then
--         table_entry.level = 1
--       end
--       if type == "atx_h2_marker" then
--         table_entry.level = 2
--       end
--       if type == "atx_h3_marker" then
--         table_entry.level = 3
--       end
--       if type == "atx_h4_marker" then
--         table_entry.level = 4
--       end
--       if type == "atx_h5_marker" then
--         table_entry.level = 5
--       end
--       if type == "atx_h6_marker" then
--         table_entry.level = 6
--       end
--     end
--     if name == "title" then
